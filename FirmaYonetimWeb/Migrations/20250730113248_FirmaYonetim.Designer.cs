...
namespace FirmaYonetimWeb.Migrations
{
    ...
    [Migration("20250730113248_FirmaYonetim")]
    partial class FirmaYonetim
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FirmaYonetimWeb.Models.BelediyePersonel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("BelediyePersonelleri");
                });

            modelBuilder.Entity("FirmaYonetimWeb.Models.GeoServer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FirmaYonetimWeb.Models.Gorev", b =>
                {
                    ...
                    b.Property<int>("BelediyePersonelId")
                        .HasColumnType("integer");

                    b.Property<DateTime>("CreatedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DosyaAdiJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("FirmaYonetimWeb.Models.Gorev", b =>
                {
                    ...
                    b.HasOne("FirmaYonetimWeb.Models.BelediyePersonel", "BelediyePersonel")
                        .WithMany()
                        .HasForeignKey("BelediyePersonelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FirmaYonetimWeb.Models.Belediye", b =>
                {
                    ...
                    b.Navigation("BelediyePersoneller");
                });
